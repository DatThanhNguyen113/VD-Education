...
public class ChangePassTask extends AsyncTask<Void, Boolean, Integer> {
    private Context mContext;
    private IViewUpdateInfo iView;
    private int status_code = 0;
    private Map<String, String> mMap;
    private ProgressDialog dialog;

    public ChangePassTask(Context mContext, IViewUpdateInfo iView, Map<String, String> map) {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        dialog = ProgressDialog.show( mContext, "", "Update User Information.Please wait...." );
        dialog.show();
    }
    ...
    protected Integer doInBackground(Void... voids) {
        ...
        HttpURLConnection httpURLConnection = connection.ConnectContent( "/accountservice/changepassword" );
        try {
