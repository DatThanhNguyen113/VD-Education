...
public class UpdateInfoTask extends AsyncTask<Void, Boolean, Integer> {
    ...
    public UpdateInfoTask(Context mContext, IViewUpdateInfo iView, Map<String, String> map) {
...
//        sqLite = new SQLite( mContext );
    ...
    protected Integer doInBackground(Void... voids) {
        ...
        HttpURLConnection httpURLConnection = connection.ConnectContent( "/accountservice/userupdate" );
        try {
