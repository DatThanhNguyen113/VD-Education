...
namespace Datalayer.DataObject.Base
{
    public class CDaoBase
    {
        ...
        // "Data Source={0};Initial Catalog={1};MultipleActiveResultSets=True;Max Pool Size=500;Connection Timeout=30";
        //protected static string sConnectionString = "Data Source=.;Initial Catalog=BlockChain;Integrated Security=True";
        ...
        private const string CALLFUNCTIONSTORENAME = "core.Sys_CallFunction";
        ...
        public CDaoBase()
        {
            ...
            sConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["defaultconnection"].ConnectionString;
            // sConnectionString = string.Format(sConnectionString, server, database);
            conn = new SqlConnection(sConnectionString);
        }
        public CDaoBase(string server, string database, string user, string pass)
        {
            sConnectionString = "Data Source={0};Initial Catalog={1};MultipleActiveResultSets=True;Max Pool Size=500;User ID={2};Password={3};Connection Timeout=300";
